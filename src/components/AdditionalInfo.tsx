...
export function AdditionalInfo({ jobInfo }: JobInfoProps):JSX.Element {
        ...
        <div className="flex flex-col mt-[20px]">
            ...
            <div className="flex flex-col justify-between border-t-2 border-[#3A4562]">
                ...
                <div className="flex justify-evenly max-[625px]:flex-wrap">
                    { jobInfo?.employment_type?.map((el:string,index:number) =>
                        <div
                            key={ index }
                ...
                <div className="flex justify-evenly  max-[625px]:flex-wrap">
                    { jobInfo?.benefits?.map((el:string,index:number) =>
                        <div
                            key={index}
